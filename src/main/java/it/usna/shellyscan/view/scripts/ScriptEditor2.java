 ...
 * @author usna
 */
public class ScriptEditor2 extends JFrame {
	private static final long serialVersionUID = 1L;
	
	public ScriptEditor2(ScriptsPanel originatingPanel, Script script) throws IOException {
//		super(LABELS.getString("dlgScriptEditorTitle") + " - " + script.getName());
		setIconImage(Main.ICON);

		ScriptEditorPanel editor = new ScriptEditorPanel(this, "script.getCode()") {
			private static final long serialVersionUID = 1L;
			...
			protected JToolBar createToolbar(JToolBar toolBar) {
				...
				UsnaAction uploadAction = new UsnaAction(ScriptEditor2.this, "btnUpload", "btnUploadTooltip", "/images/Upload24.png", null, e -> {
				...
				UsnaAction openAction = new UsnaAction(ScriptEditor2.this, "dlgOpen", "/images/Open24.png", e -> {
					...
					if(fc.showOpenDialog(ScriptEditor2.this) == JFileChooser.APPROVE_OPTION) {
				...
				UsnaAction saveAsAction = new UsnaAction(ScriptEditor2.this, "dlgSave", "/images/Save24.png", e -> {
					final JFileChooser fc = new JFileChooser(path);
					fc.setFileFilter(new FileNameExtensionFilter(LABELS.getString("filetype_js_desc"), DialogDeviceScriptsG2.FILE_EXTENSION));
					if(fc.showSaveDialog(ScriptEditor2.this) == JFileChooser.APPROVE_OPTION) {
						try {
							...
							JOptionPane.showMessageDialog(ScriptEditor2.this, LABELS.getString("msgFileSaved"), LABELS.getString("dlgScriptEditorTitle"), JOptionPane.INFORMATION_MESSAGE);

 ...
 * @author usna
 */
public class Shelly1LG4 extends AbstractG4Device implements ModulesHolder, InternalTmpHolder {
	public static final String ID = "S1LG4";
	public static final String MODEL = "S4SW-0A1X1EUL";
	private Relay relay0 = new Relay(this, 0);
	private Relay[] relaysArray = new Relay[] {relay0};
	private String inputKey;
	private float internalTmp;

	public Shelly1LG4(InetAddress address, int port, String hostname) {

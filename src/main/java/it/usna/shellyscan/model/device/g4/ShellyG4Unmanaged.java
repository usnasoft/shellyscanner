...
public class ShellyG4Unmanaged extends AbstractG4Device implements ShellyUnmanagedDeviceInterface {
	...
	public ShellyG4Unmanaged(InetAddress address, int port, String hostname) {
		super(address, port, hostname);
	}
	
	public ShellyG4Unmanaged(InetAddress address, int port, String hostname, Throwable e) {
		super(address, port, hostname);
		this.ex = e;
	...
	public String toString() {
		if(ex == null) {
			return "Shelly G4 (unmanaged) " + type + ": " + super.toString();
		} else {
			return "Shelly G4 (unmanaged): " + super.toString() + " Error: " + ex.getMessage();
		}
	}
}
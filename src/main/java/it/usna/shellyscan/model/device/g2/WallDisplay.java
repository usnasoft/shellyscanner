 ...
 * @author usna
 */
public class WallDisplay extends AbstractG2Device implements WallDisplayInterface, ModulesHolder {
	...
	public boolean setDebugMode(LogMode mode, boolean enable) {
		if(mode == LogMode.SOCKET) {
			...
			return postCommand("Sys.SetConfig", "{\"udp\": {\"debug\":{\"websocket\":{\"enable\": false}, \"mqtt\":{\"enable\": false}}}}") == null;
		} else {
			return false;
		}
	}

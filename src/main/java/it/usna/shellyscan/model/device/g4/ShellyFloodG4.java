...
/**
 * Shelly Flood G4 model
 */
public class ShellyFloodG4 extends AbstractBatteryG4Device implements ModulesHolder {
	public static final String ID = "FloodSensorG4";
	public static final String MODEL = "S4SN-0071A";
	...
	public ShellyFloodG4(InetAddress address, int port, String hostname) {

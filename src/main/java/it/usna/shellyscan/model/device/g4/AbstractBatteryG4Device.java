...
public abstract class AbstractBatteryG4Device extends AbstractG4Device implements BatteryDeviceInterface {
	private static final Logger LOG = LoggerFactory.getLogger(AbstractBatteryG4Device.class);
	...
	protected AbstractBatteryG4Device(InetAddress address, int port, String hostname) {

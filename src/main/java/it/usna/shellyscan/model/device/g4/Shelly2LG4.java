 ...
 * @author usna
 */
public class Shelly2LG4 extends AbstractG4Device implements ModulesHolder, InternalTmpHolder {
	public static final String ID = "S2LG4";
	public static final String MODEL = "S4SW-0A2X4EUL";
	...
	public Shelly2LG4(InetAddress address, int port, String hostname) {
